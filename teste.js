...
/* Dobrar valores
   ...
   /* Verificar se todos os elementos de um array são maiores que 10
      ...
      Verifica se os elementos de um array passa por um teste especifico. Pode ser
      parecido com a ideia do filter, mas o filter retorna um novo array e o every 
      retorna um booleano
      ========================================================================== */
  ...
  //  console.log( anotherArray.every( elem => elem > 10 ) )
   ...
   const tchurma = [
     { id: 12, name: "Frederico", age: 83 },
     { id: 47, name: "Francisca", age: 75 },
     { id: 77, name: "Ramon", age: 48 },
     { id: 85, name: "Zenon", age: 52 }
   ]

   
    //  console.log("TODOS MAIORES DE IDADE?", tchurma.every( person => person.age >= 18 ) )
   ...
   /* ==========================================================================
      some() - se pelo menos um elemento do array passa pelo teste
      ========================================================================== */
